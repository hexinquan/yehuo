...
public class Controller {
    ...
    @PostMapping(value = "/payPassword", produces = "application/json;charset=UTF-8")
    public Object payPassword(@RequestBody PayPasswordRequest request) {
        return mService.payPassword(request);
    }

    @PostMapping(value = "/payPasswordVal", produces = "application/json;charset=UTF-8")
    public Object payPassword(@RequestBody PayPasswordValRequest request) {
        return mService.payPasswordVal(request);
    }

    @GetMapping(value = "/payPasswordStatus", produces = "application/json;charset=UTF-8")
    public Object payPasswordStatus(String id) {
        return mService.userPassword(id);
    }

    @PostMapping(value = "/payPasswordRest", produces = "application/json;charset=UTF-8")
    public Object payPasswordRest (@RequestBody PayPasswordRestRequest payPasswordRestRequest) {
        return mService.payPasswordRest(payPasswordRestRequest);
    }
    ...
    @PostMapping(value = "/get_bet_url")
    public Object getBetUrl() throws IOException {
        return mService.getBetUrl();
    }
