...
public class RestResult {
    public enum  RestCode {
        ...
        ERROR_PASSWORD_FAIL(15, "密码错误"),
        ERROR_PASSWORD_COF(16, "两次密码不一致"),
        ERROR_PASSWORD_DIC(16, "原密码与新密码一致"),
        ERROR_PASSWORD_LEN(17, "密码长度必须是6位数字"),
        ERROR_PASSWORD_OLD(18, "原密码错误"),
        ERROR_PARAM_FAL(19, "请输入密码"),
        ERROR_PASSWORD_FAL(20, "密码错误"),
        ERROR_USER_ERROR(21, "用户不存在");
        public int code;
        public String msg;
